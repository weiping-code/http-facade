...
@Slf4j
public class HttpClientAliyunAppCodeAuthFilterTest extends BaseTest {
    @ParameterizedTest
    ...
    void testHttpClientServerCombinations(HttpClientConfig clientConfig, HttpServerConfig serverConfig) throws Exception {
        ...
        requestFilters.add(new AliyunAppCodeAuthRequestFilter("xxx"));
        ...
        server.addRoute("/hello", method, request -> {
            ...
            if (authorization == null || !"APPCODE xxx".equals(authorization.get(0))) {
